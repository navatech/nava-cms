				...
				<div class="form-group form-group-default">
					...
					<div class="controls">
						<?= $form->field($model, 'login', [
							...
							'template' => '{beginLabel} <span class="block input-icon input-icon-right">{input}<i class="ace-icon fa fa-user"></i></span>{endLabel}'
						])->textInput([
							'autofocus'   => 'autofocus',
							'class'       => 'form-control',
				...
				<div class="form-group form-group-default">
					...
					<div class="controls">
						<?= $form->field($model, 'password', [
							'labelOptions' => ['class' => 'block clearfix'],
							'template' => '{beginLabel} <span class="block input-icon input-icon-right">{input}<i class="ace-icon fa fa-lock"></i>{endLabel}'
						])->passwordInput([
							'autofocus'   => 'autofocus',
							'class'       => 'form-control',
